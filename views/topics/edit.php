...
<div class="card">
    <div class="card-body">
        <form action="/admin/topics/update" method="POST">
            ...
            <input type="hidden" name="id" value="<?= (int) ($topic['id'] ?? 0) ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                       ...
                       value="<?= htmlspecialchars($oldInput['name'] ?? $topic['name'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                       required>
            ...
            <div class="mb-3">
                ...
                <textarea id="description"
                          name="description"
                          class="form-control"
                          rows="3"><?= htmlspecialchars($oldInput['description'] ?? $topic['description'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
